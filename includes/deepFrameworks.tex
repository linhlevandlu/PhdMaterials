...
Deep learning is more and more popular in many application domains over the last few year, there have a lot of laboratory (...) and industry group (Google, Facebook, Amazon) to develop the software frameworks. That thing is help easily to create and test the neural networks. At this time, many frameworks have been proposed for deep learning (see the complete list of deep learning software at DeepLearning.net \footnote{$http://deeplearning.net/software\_links/$} or DeepLearing4j.org \footnote{$https://deeplearing4j.org$}). In this section, we represent the main characterof some of the widely used software frameworks: Caffe, Theano, TensorFlow, Torch; and the frameworks that used for other domain than computer vision, such as DyNet, DSSTNE.
\subsection{Caffe}
