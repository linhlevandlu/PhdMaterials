...
\begin{figure}[h!]
\centering
\subfloat[Image alignment with PCA]{\label{figpcai1}\includegraphics[width=0.4\textwidth]{./images/pca1}}~~
\subfloat[Image alignment with PCAI]{\label{figpcai2}\includegraphics[width=0.4\textwidth]{./images/pca2}}
