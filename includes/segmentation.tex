...
\begin{figure}[h!]
\centering
\subfloat[Bounding box on madible of beetle]{\label{figrbox1}\includegraphics[width=0.4\textwidth]{./images/rbox1}}~~
\subfloat[Bounding box on body of beetle]{\label{figrbox2}\includegraphics[width=0.4\textwidth]{./images/rbox2}}
