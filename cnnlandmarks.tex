...
To evaluate the stability and confidence of the model, we proposed four ways  to propose data (the way to choose the images for test set) as Table.\ref{choosedata}:\\
\begin{table}[h!]
	\centering
	\begin{tabular}{c l l}
	...
	\end{tabular}
	\caption{The ways to choose the data for the network}
	\label{choosedata}
\end{table}~\\
Following the ways to choose the data, the loss of training and validation is shown in Table \ref{losschoosedata}:
\begin{table}[h!]
	\centering
	\begin{tabular}{c l l}
...
\begin{table}[h!]
	...
	\begin{tabular}{l l l l l l l l l l l l l l l l l}
	  layer 0 & layer 1 & layer 2 & layer 3 & layer 4 & layer 5 & layer 6 & layer 7 & layer 8 & layer 9 & layer 10 & layer 11 & layer 12 & layer 13 & layer 14 & layer 15 & layer 15 \\ \hline
